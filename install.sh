...
cd /etc/ppp 
rm  pptpd-options 
https://raw.githubusercontent.com/timon49/webmin-mumble-django-pptp/main/pptpd-options 
cd /etc/ppp 
rm  chap-secrets 
https://raw.githubusercontent.com/timon49/webmin-mumble-django-pptp/main/chap-secrets 
